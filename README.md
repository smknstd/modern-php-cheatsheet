...
> **Note:** Concepts introduced here are based on the most recent version of php available ([Php8](https://www.php.net/releases/8.0/en.php) at the time of the last update) 
